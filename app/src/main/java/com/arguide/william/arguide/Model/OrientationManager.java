...
public class OrientationManager implements SensorEventListener {
    ...
    public OrientationManager(SensorManager sensorManager, WindowManager windowManager) {
    ...
    public void startListening(Listener listener) {
        ...
        if (mRotationSensor == null) {
            Log.e("","Rotation vector sensor not available; will not provide orientation data.");
            return;
        }
